...
app.get('/user', verificarAutenticacion, (req, res) => {
...
app.put('/user/update/me', verificarAutenticacion, (req, res) => {
...
app.get('/user/me', verificarAutenticacion, (req, res) => {
...
// agrego nuevo posteo
app.post('/posts', verificarAutenticacion, upload.single('image'), (req, res) => {
...
app.get('/posts/to-validate', (req, res) => {
...
app.put('/posts/:postId/validate', (req, res) => {
...
app.get('/posts/user/me', verificarAutenticacion, (req, res) => {
...
app.put('/posts/:id', verificarAutenticacion, upload.single('image'), (req, res) => {
...
// Borro un posteo
app.delete('/posts/:id', verificarAutenticacion, (req, res) => {
...
// obtener reseñas
app.get('/posts/:postId/reviews', (req, res) => {
  const { postId } = req.params;
  const sql = `
...
// Editar reseña
app.put('/reviews/:reviewId', verificarAutenticacion, [
  check('rating').isInt({ min: 1, max: 5 }),
  check('comment').optional().isString()
], (req, res) => {
  const errors = validationResult(req);
...
// borrar reseña
app.delete('/reviews/:reviewId', verificarAutenticacion, (req, res) => {
  const { reviewId } = req.params;
  const userId = req.session.usuarioId;
...
app.post('/forums', verificarAutenticacion, (req, res) => {
...
// Modifico un Foro
app.put('/forums/:id', verificarAutenticacion, (req, res) => {
  const { title, body } = req.body;
...
// Borro un foro
app.delete('/forums/:id', verificarAutenticacion, (req, res) => {
...
app.post('/forums/:forumId/comments', 
  verificarAutenticacion,
  (req, res) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
...
// obtener comentarios
app.get('/forums/:forumId/comments', (req, res) => {
  const { forumId } = req.params;
  const sql = `
...
app.put('/forums/:id/comments/:id', verificarAutenticacion, (req, res) => {
  const {body } = req.body;
...
// Borro un comentario
app.delete('/forums/:id/comments/:id', verificarAutenticacion, (req, res) => {
